    ...
    <>
      <div className="flex justify-center">
        <div className="md:w-1/2 flex-col gap-10 my-10 font-custom">
          ...
          <p>Updated at September 9th, 2024</p>
          <p>&nbsp;</p>
          <p>
            Epash (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;) is
          ...
          <p>
            ...
            application, Epash. By accessing or using our Service, you signify
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">Definitions and key terms</h2>
          <p>
          ...
          <ul className="list-disc">
            ...
            <li>
              ...
              refers to SIA Epash, (Titurgas iela 6-38, Baloži, Latvia), that is
              responsible for your information under this Privacy Policy.
            </li>
            <li>
              Country: where Epash or the owners/founders of Epash are based, in
              this case is Latvia
            </li>
            <li>
              Customer: refers to the company, organization or person that signs
              up to use the Epash Service to manage the relationships with your
              consumers or service users.
            </li>
            <li>
              Device: any internet connected device such as a phone, tablet,
              computer or any other device that can be used to visit Epash and
              use the services.
            </li>
            <li>
            ...
            <li>
              Personnel: refers to those individuals who are employed by Epash
            ...
            <li>
              Service: refers to the service provided by Epash as described in
            ...
            <li>
              Website: Epash&rsquo;s site, which can be accessed via this URL:
              https://www.epashai.com/
            </li>
            <li>
              You: a person or entity that is registered with Epash to use the
              Services.
            </li>
          </ul>
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">What Information Do We Collect?</h2>
          <p>
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">When does Epash use end user information from third parties?</h2>
          <p>
            Epash will collect End User Data necessary to provide the Epash
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">When does Epash use customer information from third parties?</h2>
          <p>
            ...
            interest in becoming a Epash customer, we receive information from a
            third party that provides automated fraud detection services to
            Epash. We also occasionally collect information that is made
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">Do we share the information we collect with third parties?</h2>
          <p>
          ...
          <p>
            Epash will collect personal information that you submit to us. We
            may also receive personal information about you from third parties
            as described above.
          </p>
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">How Do We Use The Information We Collect?</h2>
          <p>
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">How Do We Use Your Email Address?</h2>
          <p>
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">How Long Do We Keep Your Information?</h2>
          <p>
            We keep your information only so long as we need it to provide Epash
            ...
            with our legal or regulatory obligations, we&rsquo;ll either remove
            it from our systems or depersonalize it so that we can't identify
            you.
          </p>
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">How Do We Protect Your Information?</h2>
          <p>
            ...
            information you transmit to Epash or guarantee that your information
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">Could my information be transferred to other countries?</h2>
          <p>
            Epash is incorporated in Latvia. Information collected via our
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">
            Is the information collected through the Epash Service secure?
          </h2>
          <p>
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">Can I update or correct my information?</h2>
          <p>
            The rights you have to request updates or corrections to the
            information Epash collects depend on your relationship with Epash.
          ...
          <p>
            If you are a Epash worker or applicant, we collect information you
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">Sale of Business</h2>
          <p>
            ...
            all of the assets of Epash or any of its Corporate Affiliates (as
            defined herein), or that portion of Epash or any of its Corporate
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">Affiliates</h2>
          <p>
            ...
            control with Epash, whether by ownership or otherwise. Any
          ...
          <p>
            This Privacy Policy is governed by the laws of Latvia without regard
          ...
          <p>&nbsp;</p>
          <p>
            By using Epash or contacting us directly, you signify your
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">Your Consent</h2>
          <p>
            ...
            it's being used. By using our Epash, registering an account, or
            making a purchase, you hereby consent to our Privacy Policy and
            agree to its terms.
          </p>
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">Links to Other Websites</h2>
          <p>
            This Privacy Policy applies only to the Services. The Services may
            contain links to other websites not operated or controlled by Epash.
            ...
            link on our platform, is subject to that website&rsquo;s own rules
          ...
          <p>
            Epash uses "Cookies" to identify the areas of our website that you
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">Blocking and disabling cookies and similar technologies</h2>
          <p>
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">Remarketing Services</h2>
          <p>
            ...
            &ldquo;following&rdquo; people around the internet by serving ads on
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">Kids' Privacy</h2>
          <p>
            ...
            under the age of 18 without verification of parental consent, We
            take steps to remove that information from Our servers.
          </p>
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">Changes To Our Privacy Policy</h2>
          <p>
          ...
          <p>&nbsp;</p>
          <p>
            You acknowledge and agree that Epash shall not be responsible for
            any Third-Party Services, including their accuracy, completeness,
            timeliness, validity, copyright compliance, legality, decency,
            quality or any other aspect thereof. Epash does not assume and shall
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">Facebook Pixel</h2>
          <p>
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">Tracking Technologies</h2>
          <p>&nbsp;</p>
          <ul>
            <li>Cookies</li>
          </ul>
          ...
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">Information about General Data Protection Regulation (GDPR)</h2>
          <p>
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">What is GDPR?</h2>
          <p>
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">What is personal data?</h2>
          <p>
          ...
          <p>&nbsp;</p>
          <h2 className="text-2xl font-black">Why is GDPR important?</h2>
          <p>
            ...
            the right thing to do. At Epash we strongly believe that your data
          ...
          <p>
            ...
            rights requirements of GDPR. Epash processes or stores all personal
          ...
          <p>&nbsp;</p>
          <ul>
            <li>Via Email: support@epashai.com</li>
            <li>Via this Link: <a href="https://www.epashai.com/support" className="text-epash-green underline"></a>https://www.epashai.com/support</li>
          </ul>
        </div>
      </div>
    </>
