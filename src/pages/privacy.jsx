    ...
    <>
      <div className="flex justify-center">
        <div className="md:w-1/2 flex-col gap-10 my-10 font-custom">
          ...
          <p>&nbsp;</p>
          <h2>When does Epash use end user information from third parties?</h2>
          <p>
          ...
          <p>&nbsp;</p>
          <h2>When does Epash use customer information from third parties?</h2>
          <p>
          ...
          <ul>
            ...
            <li>Via this Link: https://www.epashai.com/support</li>
          </ul>
        </div>
      </div>
    </>
